...
xemo.core.sop = function (data, callback) {
    $.post('http://kmcg3413.net:7634', xemo.core.objtojson(params), callback);
}
...
xemo.core.opendoc = function (key, ext, contents) {
    $.get('v1api.py', { key: key, op: 'gen_document', data: contents, ext: ext}, function (data) {
...
/*
    BROKEN...
*/
xemo.core.textcalendar.refineRoughShiftsOverlapping = function (shifts) {
