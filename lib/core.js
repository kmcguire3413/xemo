    ...
    */
    for (var i = 0; i < shifts.length; ++i) {
        ...
        if (!shift.id) {
            ...
            payperiodref = new Date(paysysinfo.systems[paysysinfo.mapping[shift.id]].payperiodref * 1000);
        }
...
Shift.prototype.samePersonnelAs = function (shift) {
    if (this.id == undefined && shift.id == undefined) {
    ...
    if (this.id == shift.id && this.id != undefined) {
        return true;
    }
