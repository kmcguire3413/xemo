...
xemo.plugins.Reports.mods.Timesheet = function (reports, frame, params) {
    ...
    for (var sysid in paysysinfo.systems) {
        var ppref = new Date(paysysinfo.systems[sysid].payperiodref * 1000);
        bounds[sysid] = xemo.core.getBoundaryForRangeRegardingPayPeriodRef(from, to, ppref);
    }
    ...
    for (var i = 0; i < shifts.length; ++i) {
        ...
        var boundary = bounds[paysysinfo.mapping[shift.pid]];
